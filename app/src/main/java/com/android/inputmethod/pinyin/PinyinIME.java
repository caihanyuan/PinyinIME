...
public class PinyinIME extends InputMethodService {
    ...
    public void showOptionsMenu() {
        ...
        try {
            Class stringClass = Class.forName("com.android.internal.R&string");
            Field field = stringClass.getDeclaredField("inputMethod");
            int sourceId = field.getInt(stringClass.newInstance());
            itemInputMethod = getString(sourceId);
        } catch (Exception e) {
            e.printStackTrace();
        }
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface di, int position) {
                        ...
                        switch (position) {
                            ...
                            case 1:
                                try {
                                    Class inputMethodClass = InputMethodManager.class;
                                    Object inputObject = inputMethodClass.newInstance();
                                    InputMethodManager inputManager = (InputMethodManager) inputMethodClass.getMethod("getInstance").invoke(inputObject);
